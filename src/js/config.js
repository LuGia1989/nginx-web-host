  ...
  apps: [
    {
      ...
      icon: "\uD83D\uDCC8",
      url: "__APP1_URL__",
      bgImage: "img/stock.webp",
      screenImage: "img/stock-screen.webp",
      screenAnim: "float",
    ...
    },
    {
      ...
      icon: "\uD83E\uDDE0",
      url: "__APP2_URL__",
      bgImage: "img/ai-models.webp",
      screenImage: "img/ai-models-screen.webp",
      screenAnim: "scan",
    ...
    },
    {
      ...
      icon: "\uD83D\uDE97",
      url: "__APP3_URL__",
      bgImage: "img/yolo11.webp",
      screenImage: "img/yolo11-screen.webp",
      screenAnim: "drive",
    ...
    },
    {
      ...
      icon: "\uD83E\uDDE5",
      url: "__APP4_URL__",
      bgImage: "img/fashion.webp",
      screenImage: "img/fashion-screen.webp",
      screenAnim: "walk",
    ...
    {
      id: "kamiwaza",
      name: "Kamiwaza Enterprise AI Agent Orchestration.",
      icon: "\uD83E\uDDE5",
      logoImage: "img/kamiwaza-logo-light.svg",
      url: "__APP5_URL__",
      bgImage: "img/kamiwaza.webp",
      screenImage: "img/kamiwaza-screen.webp",
      screenAnim: "typewriter",
      description: "The Kamiwaza-Ampere solution enables sophisticated AI workloads to run on energy-efficient CPU architecture without sacrificing performance. By combining Kamiwaza's multi-agent AI orchestration with Ampere's cloud native processors, we've created a practical approach to enterprise AI that delivers: 3-5x lower power consumption than alternatives, On-premises deployment for complete data sovereignty, Standard server infrastructure without specialized cooling. Our joint solution enables a variety of enterprise AI use cases, each leveraging the efficiency of Ampere processors and the intelligence of Kamiwaza's orchestration.",
      color: "#10b981",
      tags: ["Kamiwaza Enterprise AI Agent Orchestration.", "enables sophisticated AI workloads on energy-efficient CPU architecture without sacrificing performance", "Ampere CPU"],
      // version: "v1.5.0"
    }	  
  ]
};
